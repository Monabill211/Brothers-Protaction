    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Contact Cards */}
          {[
            { title: "رقم الهاتف", value: "01003397852", icon: <CallIcon />, link: "tel:+201003397852" },
            { title: "واتساب", value: "01003397852", icon: <WhatsAppIcon />, link: "https://wa.me/201003397852" },
            { title: "البريد الإلكتروني", value: "info@brothersprotection.com", icon: <AttachEmailIcon />, link: "mailto:info@brothersprotection.com" },
            { title: "فرع الشيخ زايد", value: "الشيخ زايد - محور جمال عبد الناصر - ممشي Square One", icon: <AddLocationAltIcon />, link: "https://maps.app.goo.gl/YtUA9sgrZxYNLtd98?g_st=ic" },
